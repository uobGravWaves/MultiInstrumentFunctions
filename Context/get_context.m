...
%     Sentinel_ForceDownload (logical       false)  Don't check download size is OK if it's large
...
addParameter(p,'Sentinel_ForceDownload',false,             @islogical); %flag to force download without checking if it's expected to need many requests
